...
class Step1XEdit(nn.Module):
    ...
    def __init__(self, params: Step1XParams):
        ...
        self.landmark_in = nn.Linear(self.hidden_size, self.hidden_size)
    ...
    def forward(
        ...
        img = self.img_in(img)
        landmark_latents = self.landmark_in(landmark_latents.permute(0, 2, 1))
        img = torch.cat([img, landmark_latents], dim=1)
